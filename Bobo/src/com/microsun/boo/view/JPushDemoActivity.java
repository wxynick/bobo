...
public class JPushDemoActivity extends JPushBaseActivity implements OnClickListener{
	...
	private void initView(){
		...
		String udid =  AppUtil.getImei(getApplicationContext(), "");
        if (null != udid) mImei.setText("IMEI: " + udid);
        
		TextView mAppKey = (TextView) findViewById(R.id.tv_appkey);
		String appKey = AppUtil.getAppKey(getApplicationContext());
		...
		String versionName =  AppUtil.GetVersion(getApplicationContext());
	...
	public void onClick(View v) {
		...
		case R.id.init:
			...
			break;
		case R.id.setting:
			Intent intent = new Intent(JPushDemoActivity.this, PushSetActivity.class);
	...
	public static final String MESSAGE_RECEIVED_ACTION = "com.microsun.boo.MESSAGE_RECEIVED_ACTION";
